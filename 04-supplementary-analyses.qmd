...
If a participant brings back 5 used applicators and 2 unused applicators, should `number_applicator` be 5 or 7?  
...
Among participants colonized at (primary outcome), LBP strains made up >= 50% in 0.849%. 
